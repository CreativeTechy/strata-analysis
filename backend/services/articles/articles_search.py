...
def _fetch_all_articles(search=None, sentiment=None, category=None, project_id=None, *, select=ARTICLES_SELECT, order=DEFAULT_SORT, limit=SEARCH_SCAN_LIMIT, date_from=None, date_to=None, source_url=None, source_host=None, added_from=None, added_to=None, status=None):
...
def search_results(search=None, sentiment=None, category=None, project_id=None, date_from=None, date_to=None, source_url=None, source_host=None, added_from=None, added_to=None, status=None, select=ARTICLES_SELECT):
