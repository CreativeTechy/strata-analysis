...
try:
    EVIDENCE_PASSAGE_DIRECT_THRESHOLD = float(os.environ.get("EVIDENCE_PASSAGE_DIRECT_THRESHOLD", "0.72"))
    EVIDENCE_PASSAGE_CONTEXTUAL_THRESHOLD = float(os.environ.get("EVIDENCE_PASSAGE_CONTEXTUAL_THRESHOLD", "0.62"))
except ValueError:
    EVIDENCE_PASSAGE_DIRECT_THRESHOLD = 0.72
    EVIDENCE_PASSAGE_CONTEXTUAL_THRESHOLD = 0.62
EVIDENCE_PASSAGE_DIRECT_THRESHOLD = max(-1.0, min(1.0, EVIDENCE_PASSAGE_DIRECT_THRESHOLD))
EVIDENCE_PASSAGE_CONTEXTUAL_THRESHOLD = max(-1.0, min(
    EVIDENCE_PASSAGE_DIRECT_THRESHOLD, EVIDENCE_PASSAGE_CONTEXTUAL_THRESHOLD
))
...
# Retained for compatibility with older configurations. Current Evidence rules
# do not use embedding similarity to merge assertions.
